class AudioPlayer {
    ...
    setSourcesInit() {
        ...
        if (this.init) {
            ...
            if (this.streamingMode) {
                ...
                this.songName.innerHTML = `<a target="_blank" href="https://youtube.com/watch?v=${this.ids[this.rnd]}">${this.songAuthors[this.rnd]} - ${
    ...
    setSources(i) {
        ...
        if (this.streamingMode) {
            ...
            this.songName.innerHTML = `<a target="_blank" href="https://youtube.com/watch?v=${this.ids[i]}">${this.songAuthors[i]} - ${this.songNames[i]}</a>`;
        } else {
